...
import { addMedicinesData, deleteMedicinesData, getMedicinesData, upadateMedicineData } from "../../common/apis/medicine.api";
...
export const upadateMedicine = (data) => (dispatch) => {
  try {
    ...
    upadateMedicineData(data)
      .then(dispatch(({ type: ActionTypes.UPADATE_MEDICINE, payload: data })))
      .catch((error) => dispatch(errorMedicine(error.message)))
